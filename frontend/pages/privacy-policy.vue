...
<template>
    <div class="container mx-auto py-8 px-4">
      ...
      <section class="mb-6">
        ...
        <p>
          Welcome to Spectre Insights. We value your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
        </p>
      </section>
      ...
      <section class="mb-6">
        ...
        <p>
          We may collect personal information that you voluntarily provide to us when registering on the website, expressing an interest in obtaining information about us or our products and services, when participating in activities on the website, or otherwise contacting us.
        </p>
      ...
      <section class="mb-6">
        ...
        <ul class="list-disc list-inside">
          <li>Consent: We may process your data if you have given us specific consent.</li>
          <li>Legal Obligations: We may disclose your information where we are legally required to do so.</li>
          <li>Vital Interests: We may disclose your information where we believe it is necessary to investigate, prevent, or take action regarding potential violations of our policies.</li>
        </ul>
      </section>
      ...
      <section class="mb-6">
        <h2 class="text-2xl font-semibold mb-2">6. Your Data Protection Rights</h2>
        <p>
